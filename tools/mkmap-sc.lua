...
local foundry = {
   ...
   ['fandol']   = {
      ...
      mb='FandolSong-Regular.otf',
      gr='FandolHei-Regular.otf',
      gru='FandolHei-Regular.otf',
      gb='FandolHei-Regular.otf',
      ge='FandolHei-Regular.otf',
      mgr='FandolHei-Regular.otf',
      {''},
   },
   ['founder']   = {
      noncid = true,
